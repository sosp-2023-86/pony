...
namespace dory::pony_apps::tail_p2p {
...
class SenderBuilder : private internal::Builder<SenderVariant> {
 public:
  ...
  void announceQps() override {
    internal::Builder<SenderVariant>::announcing();
    exchanger.announceAll(store, qp_ns);
  }

  void connectQps() override {
    internal::Builder<SenderVariant>::connecting();
    exchanger.connectAll(store, qp_ns);
  }

  SenderVariant build() override {
    internal::Builder<SenderVariant>::building();
